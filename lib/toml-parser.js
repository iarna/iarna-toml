...
function InlineTable () {
  return {[_type]: 'inline-table'}
}
function isInlineTable (obj) {
  if (obj === null || typeof (obj) !== 'object') return false
  return obj[_type] === 'inline-table'
}
function Table () {
  return {[_type]: 'table'}
}
...
function InlineList () {
  const obj = []
  obj[_type] = 'inline-list'
  return obj
}
function isInlineList (obj) {
  if (obj === null || typeof (obj) !== 'object') return false
  return obj[_type] === 'inline-list'
}
function List () {
  const obj = []
  obj[_type] = 'list'
  ...
  class TOMLParser extends Parser {
    ...
    type (value) {
      if (typeof value === 'string') {
        ...
        return 'date'
      } else if (isInlineTable(value) || isTable(value)) {
        return 'table'
      } else if (isInlineList(value) || isList(value)) {
        return 'list'
      } else {
        return 'invalid'
      }
