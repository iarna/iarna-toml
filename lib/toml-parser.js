...
function makeParserClass (Parser) {
  class TOMLParser extends Parser {
    ...
    parseTrue () {
      if (this.atEndOfWord()) {
        throw this.error(new TomlError('Incomplete boolean'))
      } else if ('true'.indexOf(this.state.buf + String.fromCodePoint(this.char)) !== 0) {
    ...
    parseFalse () {
      if (this.atEndOfWord()) {
        throw this.error(new TomlError('Incomplete boolean'))
      } else if ('false'.indexOf(this.state.buf + String.fromCodePoint(this.char)) !== 0) {
        throw this.error(new TomlError('Invalid boolean, expected true or false'))
